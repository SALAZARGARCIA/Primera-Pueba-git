...
CREATE TABLE IF NOT EXISTS `mydb`.`PERSONA` (
  ...
  CONSTRAINT `fk_PERSONA_TIPO_DOCUMENTO`
    ...
    REFERENCES `mydb`.`TIPO_DOCUMENTO` (`COD_TDOC`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`ROL_has_PERSONA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`ROL_has_PERSONA` (
  `ROL_COD_ROL` INT NOT NULL,
  `PERSONA_ID_PERSONA` INT NOT NULL,
  `PERSONA_TIPO_DOCUMENTO_COD_TDOC` VARCHAR(3) NOT NULL,
  `ESTADO_RP` TINYINT NOT NULL,
  PRIMARY KEY (`ROL_COD_ROL`, `PERSONA_ID_PERSONA`, `PERSONA_TIPO_DOCUMENTO_COD_TDOC`),
...
-- -----------------------------------------------------
-- Table `mydb`.`PERSONA_has_FACTURA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`PERSONA_has_FACTURA` (
  `PERSONA_ID_PERSONA` INT NOT NULL,
  `PERSONA_TIPO_DOCUMENTO_COD_TDOC` VARCHAR(3) NOT NULL,
  ...
  CONSTRAINT `fk_PERSONA_has_FACTURA_FACTURA1`
    ...
    REFERENCES `mydb`.`FACTURA` (`N_FACTURA`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`PERSONA_has_PRODUCTO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`PERSONA_has_PRODUCTO` (
  `PERSONA_ID_PERSONA` INT NOT NULL,
  `PERSONA_TIPO_DOCUMENTO_COD_TDOC` VARCHAR(3) NOT NULL,
